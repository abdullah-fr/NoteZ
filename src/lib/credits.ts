...
export const PLANS: Record<PlanTier, PlanDefinition> = {
  free: {
    id: 'free',
    name: 'Free',
    tagline: 'Build a better study system at no cost.',
    monthlyPrice: 0,
    yearlyPrice: 0,
    creditAllowance: 50,
    resetDays: 30,
    features: [
      '50 AI-powered study actions every month',
      'Notes, folders & rich editing',
      'AI chat, flashcards & practice exams',
      'Calendar, activities & Focus Timer',
      'FSRS-powered spaced-repetition review',
    ],
  },
  pro_student: {
    id: 'pro_student',
    name: 'Pro',
    tagline: 'More room for consistent, focused study.',
    monthlyPrice: 9,
    yearlyPrice: 6,
    creditAllowance: 250,
    resetDays: 30,
    ...
    badge: 'Most Popular',
    features: [
      '250 AI-powered study actions every month',
      'Everything in Free',
      '5× more AI room for regular study',
      'More practice from your notes, every week',
      'Designed for consistent weekly learning',
    ],
  },
  pro_scholar: {
    id: 'pro_scholar',
    name: 'Max',
    tagline: 'Maximum headroom for intensive study.',
    monthlyPrice: 19,
    yearlyPrice: 15,
    creditAllowance: 500,
    resetDays: 30,
    features: [
      '500 AI-powered study actions every month',
      'Everything in Pro',
      '10× the Free AI allowance',
      'More room for intensive study and research',
      'Built for heavy weekly workflows',
    ],
  },
  team: {
    id: 'team',
