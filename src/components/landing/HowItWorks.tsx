                      ...
                      <div className="max-w-sm mx-auto p-5 rounded-xl border border-border/80 bg-secondary/30 space-y-3">
                        ...
                        {!signedIn ? (
                          <button
                            ...
                            className="w-full py-2.5 px-3 rounded-lg bg-foreground text-background font-medium text-xs flex items-center justify-center gap-2 hover:opacity-90 transition-all shadow"
                          >
